export function Footer() {
  return (
    <footer className="bg-espresso text-cream border-t border-cream/10">
      <div className="max-w-[1200px] mx-auto px-6 md:px-10 py-12 md:py-16">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10 md:gap-8 mb-12">
          {/* Brand */}
          <div className="md:col-span-1">
            <div className="font-serif font-bold text-[24px] tracking-[-0.025em] mb-4">
              Coco<span className="text-charge">Classy</span>
            </div>
            <p className="text-cream/50 text-[14px] leading-[1.6] max-w-[280px]">
              A women&apos;s Pilates lab and cold-pressed juice bar.
              Pilates with a pulse. Juice with a purpose.
            </p>
          </div>
            ...
            <ul className="space-y-2 text-[14px]">
              <li>
                <a
                  ...
                  className="text-cream/65 hover:text-charge transition-colors flex items-center gap-2"
                >
              ...
              <li>
                <a href="https://instagram.com/cococlassy" className="text-cream/65 hover:text-charge transition-colors flex items-center gap-2">
                  <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
              ...
              <li className="text-cream/50 text-[13px]">hello@cococlassy.co.za</li>
            </ul>
          </div>
        </div>
        ...
        <div className="border-t border-cream/10 pt-6 flex flex-col md:flex-row items-center justify-between gap-4">
          <span className="font-mono text-[10px] tracking-[0.15em] uppercase text-cream/30">
            &copy; 2026 CocoClassy
          </span>
          <span className="font-mono text-[10px] tracking-[0.15em] uppercase text-cream/30">
            Pressed fresh daily
          </span>

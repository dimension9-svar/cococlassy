export function Footer() {
  return (
    <footer className="bg-espresso text-cream px-5 md:px-10 pt-[60px] md:pt-[80px] pb-[30px] md:pb-10">
      <div className="max-w-[1400px] mx-auto">
        {/* Top grid */}
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-[1.5fr_1fr_1fr_1fr] gap-10 md:gap-[60px] pb-[60px] border-b border-cream/[0.12]">
          {/* Brand */}
          <div>
            ...
            <p className="text-cream/65 text-[14px] leading-[1.6] mt-5 max-w-[320px]">
          ...
          <div>
            ...
            <ul className="list-none space-y-2.5">
              {["The Method", "Classes", "Memberships"].map((item) => (
                <li key={item}>
                  <a href="#method" className="text-cream/80 text-[14px] no-underline transition-colors hover:text-charge">{item}</a>
                </li>
              ))}
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="list-none space-y-2.5">
              {["Full Menu", "Cleanse Programmes", "Order Ahead"].map((item) => (
                <li key={item}>
                  <a href="#juice" className="text-cream/80 text-[14px] no-underline transition-colors hover:text-charge">{item}</a>
                </li>
              ))}
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="list-none space-y-2.5">
              {["About", "Locations", "Franchise With Us", "Careers"].map((item) => (
                <li key={item}>
                  <a href="#locations" className="text-cream/80 text-[14px] no-underline transition-colors hover:text-charge">{item}</a>
                </li>
              ))}
            </ul>
          </div>
        ...
        {/* Bottom */}
        <div className="pt-8 flex flex-col md:flex-row justify-between font-mono text-[11px] tracking-[0.1em] text-cream/50 gap-4">
